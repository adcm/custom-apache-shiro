 ...
 */
@Aspect()
public class MyShiroAnnotationAuthorizingAspect {
    ...
    private MyAspectjAnnotationsAuthorizingMethodInterceptor interceptor =
            new MyAspectjAnnotationsAuthorizingMethodInterceptor();
